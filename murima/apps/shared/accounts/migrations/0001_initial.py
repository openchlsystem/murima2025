    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, help_text='Optional. Phone number for SMS notifications and 2FA.', max_length=17, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in the format: "+999999999". Up to 15 digits allowed.', regex='^\\+?1?\\d{9,15}$')], verbose_name='phone number')),
                ...
                ('email_verified_at', models.DateTimeField(blank=True, help_text='Date and time when email was verified.', null=True, verbose_name='email verified at')),
                ('phone_verified_at', models.DateTimeField(blank=True, help_text='Date and time when phone was verified.', null=True, verbose_name='phone verified at')),
                ('two_factor_enabled', models.BooleanField(default=False, help_text='Whether 2FA is enabled for this user.', verbose_name='two-factor authentication enabled')),
                ('preferred_2fa_method', models.CharField(choices=[('email', 'Email'), ('sms', 'SMS'), ('whatsapp', 'WhatsApp')], default='email', help_text='Preferred method for receiving 2FA codes.', max_length=20, verbose_name='preferred 2FA method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_type', models.CharField(choices=[('login_2fa', 'Two-Factor Authentication'), ('email_verification', 'Email Verification'), ('phone_verification', 'Phone Verification'), ('password_reset', 'Password Reset'), ('account_unlock', 'Account Unlock')], help_text='The purpose of this OTP token.', max_length=20, verbose_name='token type')),
