          ...
          <div v-if="currentStep === 'username'" class="step-content">
            ...
            <div class="input-group">
              ...
              <div class="select-container">
                <select 
                  v-model="selectedMeans"
                  class="form-select"
                  :class="{ 'input-error': submitted && !selectedMeans }"
                  required
                  :disabled="loading"
                >
            ...
            <div class="otp-info">
              <div class="selected-means-display">
                ...
                <p class="otp-message">
                  ...
                  <span v-if="selectedMeans === 'phone'">via SMS to your registered phone number ending with <strong>***{{ maskedContact.phone }}</strong></span>
                  <span v-else-if="selectedMeans === 'email'">to your registered email <strong>{{ maskedContact.email }}</strong></span>
                  <span v-else-if="selectedMeans === 'whatsapp'">via WhatsApp to your registered number ending with <strong>***{{ maskedContact.phone }}</strong></span>
                </p>
              </div>
            </div>
            ...
            <div class="input-group">
              ...
              <div class="otp-input-container">
                <input 
                  ...
                  class="otp-input"
                  :class="{ 'input-error': submitted && !isOtpComplete }"
                  :disabled="loading"
                >
              </div>
